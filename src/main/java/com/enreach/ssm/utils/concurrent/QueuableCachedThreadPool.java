...
public  final class QueuableCachedThreadPool extends ThreadPoolExecutor {
     ...
     * handed to a worker concurrent but the latter did not start executing the async yet. This number is always greater or
    ...
    /**
     * Executes the given command at some time in the future. The command may execute in a new concurrent, in a pooled
     * concurrent, or in the calling concurrent, at the discretion of the <tt>Executor</tt> implementation. If no threads are
     ...
     *
     * @param command the runnable async
     * @param timeout A timeout for the completion of the async
     * @param unit    The timeout time unit
     * @throws RejectedExecutionException if this async cannot be accepted for execution - the queue is full
    ...
    protected static class ControllableQueue extends LinkedBlockingQueue<Runnable> {
        ...
        public boolean force(Runnable o) {
            ...
            return super.offer(o); // forces the item onto the queue, to be used if the async is rejected
        }
        ...
        public boolean force(Runnable o, long timeout, TimeUnit unit) throws InterruptedException {
            ...
            return super.offer(o, timeout, unit); // forces the item onto the queue, to be used if the async is rejected
        }
        ...
        public boolean offer(Runnable o) {
            ...
            // if we have less threads than maximum force creation of a new concurrent
            if (currentPoolSize < parent.getMaximumPoolSize()) {
                return false;
            }
